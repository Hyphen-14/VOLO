...
<body>
    ...
    <aside class="sidebar">
        ...
        <nav class="sidebar-nav">
            ...
            <a href="/volo/admin/booking.php" class="nav-item active">
            <span class="nav-icon">
            ...
            <section class="content-section">
                <div class="section-header">
                    <div class="section-title-group">
                        ...
                        <p class="section-subtitle">Monitor customer bookings (read-only)</p>
                    </div>
                </div>
                    ...
                    <table class="data-table">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="font-semibold">john@email.com</td>
                                <td style="font-weight: 600; color: #ffffff71;">VL-101</td>
                                <td><span class="status-badge upcoming">Business</span></td>
                                <td class="font-semibold">2024-06-15</td>
                            ...
                            <tr>
                                ...
                                <td class="font-semibold">jane@email.com</td>
                                <td style="font-weight: 600; color: #ffffff71;">VL-205</td>
                                <td><span class="status-badge expired">Economy</span></td>
                                <td class="font-semibold">2024-06-16</td>
                            ...
                            <tr>
                                ...
                                <td class="font-semibold">mike@email.com</td>
                                <td style="font-weight: 600; color: #ffffff71;">VL-342</td>
                                <td><span class="status-badge expired">Economy</span></td>
                                <td class="font-semibold">2024-06-16</td>
                                <td><span class="status-badge confirmed">Confirmed</span></td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td class="font-semibold">Sarah Wilson</td>
                                <td class="font-semibold">sarah@email.com</td>
                                <td style="font-weight: 600; color: #ffffff71;">VL-418</td>
                                <td><span class="status-badge upcoming">Business</span></td>
                                <td class="font-semibold">2024-06-17</td>
                            ...
                            <tr>
                                ...
                                <td class="font-semibold">david@email.com</td>
                                <td style="font-weight: 600; color: #ffffff71;">VL-512</td>
                                <td><span class="status-badge expired">Economy</span></td>
                                <td class="font-semibold">2024-06-18</td>
                                <td><span class="status-badge confirmed">Confirmed</span></td>
                                <td>
                                    <div class="action-buttons">
                                        <button class="btn-icon" title="Edit">
                            ...
                            <tr>
                                ...
                                <td class="font-semibold">emily@email.com</td>
                                <td style="font-weight: 600; color: #ffffff71;">VL-101</td>
                                <td><span class="status-badge expired">Economy</span></td>
                                <td class="font-semibold">2024-06-19</td>
                                <td><span class="status-badge pending">Pending</span></td>
                                <td>
                                    <div class="action-buttons">
                                        <button class="btn-icon" title="Edit">
